import os 
import sys # for using the custom exception
...
from dataclasses import dataclass # i will be directly able to define class variable
...
class DataIngestionConfig:
    ...
    raw_data_path: str = os.path.join('artificats','test.csv')
